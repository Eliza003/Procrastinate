...
import com.procrastinate.fragment.OngoingLongTermActivityFragment;
import com.procrastinate.fragment.OngoingOneTimeActivityFragment;
...
public class OngoingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // init title
        setTitle(getString(R.string.title_activity_ongoing));
        ...
        fragments = new Fragment[]{
                OngoingOneTimeActivityFragment.newInstance(),
                OngoingLongTermActivityFragment.newInstance()
        };
